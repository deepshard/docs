...
Commands:
  ...
  proxy                    Run OpenAI-compatible proxy
```
...
For `truffile chat`, runtime behavior is controlled inside REPL using slash commands (`/help`, `/config`, `/models`, `/reasoning`, `/mcp`, etc.).  
