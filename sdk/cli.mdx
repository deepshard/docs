...
Commands:
  ...
  create [name]            Create a new app scaffold
...
Create a starter app folder with `truffile.yaml`, foreground/background entrypoints, and icon:
...
If you run `truffile create` without args, the CLI prompts for app name and base path.
...
| `truffile create [name]` | Create a new app scaffold |
| `truffile create [name] --path <dir>` | Create scaffold in a specific base directory |
