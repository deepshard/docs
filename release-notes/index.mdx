        ...
        <div className="grid gap-4 px-4 py-6 sm:px-6 sm:py-7 md:grid-cols-[140px_1fr] md:gap-6 md:px-7 md:py-8">
          ...
          <div>
            ...
            <video
              ...
              playsInline
              preload="metadata"
              poster="/images/symphony/symphony-sept22-poster.jpg"
              className="mt-5 w-full rounded-2xl border border-zinc-200 bg-black object-cover sm:rounded-3xl dark:border-zinc-800"
            >
              <source
                src="/images/symphony/symphony-sept22.mp4"
                type="video/mp4"
              />
              Your browser does not support inline video playback.
            </video>
            <ul className="mt-5 space-y-2 text-base leading-7 text-zinc-700 sm:text-lg sm:leading-8 dark:text-zinc-300">
              <li>A new onboarding, a new Home screen, and a revamped Convo.</li>
              <li>Dictate to your Truffle directly from Symphony.</li>
              <li>Your Truffle can now sit in on your meetings, both online and in person.</li>
              <li>A new Settings UI, with a lot more configuration, like audio controls.</li>
            </ul>
          </div>
        </div>
      </div>
    ...
    >
      <div className="mb-10 overflow-hidden rounded-3xl border border-zinc-200 bg-white dark:border-zinc-800 dark:bg-zinc-950">
        <div className="grid gap-4 px-4 py-6 sm:px-6 sm:py-7 md:grid-cols-[140px_1fr] md:gap-6 md:px-7 md:py-8">
          ...
          <div>
            <h3 className="m-0 text-2xl font-medium tracking-tight text-zinc-950 sm:text-3xl dark:text-zinc-50">
              Multiple app accounts and tool permissions are here.
            </h3>
            <p className="mt-4 mb-0 text-base leading-7 text-zinc-700 sm:mt-5 sm:text-lg sm:leading-8 dark:text-zinc-300">
              You can now connect multiple accounts to your apps in Truffle. Bring in multiple Slack workspaces and connect both your personal and work Gmail accounts.
            </p>
            <p className="mt-4 mb-0 text-base leading-7 text-zinc-700 sm:text-lg sm:leading-8 dark:text-zinc-300">
              Tool permissions are finally here! Permissions are scoped to each account and default to read-only. Set permissions for each app connection, or choose a global permission: <strong>Read only</strong>, <strong>Read and write</strong>, or <strong>Auto review</strong>.
            </p>
            <p className="mt-4 mb-0 text-base leading-7 text-zinc-700 sm:text-lg sm:leading-8 dark:text-zinc-300">
              Head to your app settings in Symphony, or paste the following prompt to your Truffle:
            </p>

            ```text
            hey seems like you can now connect to multiple accounts and there are tool permissions. Please give me a rundown of how these two features work!
            ```
          </div>
        </div>
      </div>
      ...
      <div className="mb-10 overflow-hidden rounded-3xl border border-zinc-200 bg-white dark:border-zinc-800 dark:bg-zinc-950">
        <div className="grid gap-4 border-b border-zinc-200 px-4 py-6 sm:px-6 sm:py-7 md:grid-cols-[140px_1fr] md:gap-6 md:px-7 md:py-8 dark:border-zinc-800">
          ...
          <div>
            ...
            <img
              src="/images/symphony/icon-tray.png"
              alt="Symphony system tray menu with shortcuts and device controls."
              className="mt-5 w-full max-w-[280px] rounded-2xl sm:mt-6 sm:rounded-3xl"
            />
          </div>
        </div>
          ...
          <div>
            ...
            <div className="mt-5 overflow-hidden rounded-2xl border border-zinc-200 dark:border-zinc-800">
              <div className="flex gap-4 border-b border-zinc-200 p-4 dark:border-zinc-800">
                <img
                  src="/images/apps/Higgsfield.png"
                  alt="Higgsfield app icon."
        ...
        <div className="grid gap-4 px-4 py-6 sm:px-6 sm:py-7 md:grid-cols-[140px_1fr] md:gap-6 md:px-7 md:py-8">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2 text-base leading-7 text-zinc-700 sm:mt-5 sm:text-lg sm:leading-8 dark:text-zinc-300">
              ...
              <li>Temporary Task compatibility spellings such as <code>--task-id</code>, <code>--list-tasks</code>, <code>/tasks</code>, and the <code>task_id</code> JSON key carry only decimal Convo thread IDs.</li>
            </ul>
          </div>
        </div>
      </div>
        ...
        <div className="grid gap-4 px-4 py-6 sm:px-6 sm:py-7 md:grid-cols-[140px_1fr] md:gap-6 md:px-7 md:py-8">
          ...
          <div>
            ...
            <div className="mt-5 overflow-hidden rounded-2xl border border-zinc-200 dark:border-zinc-800">
              <div className="flex gap-4 border-b border-zinc-200 p-4 dark:border-zinc-800">
                <img
                  src="/images/apps/Alpha_Vantage.png"
                  alt="Alpha Vantage app icon."
                  className="h-12 w-12 rounded-xl border border-zinc-200 dark:border-zinc-800"
                />
                <div>
                  <h4 className="m-0 text-lg font-medium text-zinc-950 dark:text-zinc-50">
              ...
              <div className="flex gap-4 p-4">
                <img
                  src="/images/apps/Internet_Archives.png"
                  alt="Internet Archives app icon."
                  className="h-12 w-12 rounded-xl border border-zinc-200 dark:border-zinc-800"
                />
                <div>
                  <h4 className="m-0 text-lg font-medium text-zinc-950 dark:text-zinc-50">
